  ...
  return (
    ...
    className="w-full flex xl:flex-row flex-col justify-center min-h-screen gap-10 max-container">
      ...
      <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full padding-x pt-28">
          ...
          <p className="font-monserrat text-slate-gray text-lg leading-8 mt-6 mb-14 sm:max-w w-sm">Discover Stylish Nike arrivals, quality comfort, and innovation for your active life.</p>
      ...
      max-xl:py-40 bg-primary bg-hero bg-cover bg-center">
        <img src={bigShowImg} alt="Shoe Collection" width={610} height={500} className="object-contain relative z-10" />
